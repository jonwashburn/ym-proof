...
-\addplot[domain=0:30, samples=100, thick, blue] {150*sqrt(x/(x+5))};
-\addlegendentry{Model}
-\addplot[only marks, mark=*, mark size=2pt, red] coordinates {
-    (1,50) (2,80) (3,100) (5,120) (8,135) (12,145) (18,148) (25,150)
+% NGC 2403 data
...
\end{axis}
\end{tikzpicture}
-\caption{Example galaxy rotation curve showing excellent agreement between model and data.}
...
-    (0.05,2.5) (0.08,2.2) (0.1,1.8) (0.15,1.5) (0.2,1.2) 
-    (0.25,0.9) (0.3,0.7) (0.35,0.5) (0.4,0.4) (0.45,0.3)
-    (0.5,0.25) (0.6,0.2) (0.7,0.15) (0.8,0.12) (0.9,0.1)
+% Actual SPARC data
...
-\addplot[domain=0:1, samples=100, thick, red] {3*exp(-4*x)};
...
\end{axis}
\end{tikzpicture}
-\caption{Correlation between gas fraction and fit quality, demonstrating the model's preference for gas-rich systems.}
