...
def main():
    ...
    # Target files
    target_files = [
        Path("../NavierStokesLedger/SimplifiedProofs.lean"),
        Path("../NavierStokesLedger/RecognitionLemmas.lean"),
        Path("../NavierStokesLedger/ConcreteProofs.lean"),
        Path("../NavierStokesLedger/EnergyEstimates.lean"),
        Path("../NavierStokesLedger/VorticityLemmas.lean"),
    ]
