...
def TransferPFGap (_μ : LatticeMeasure) (_K : TransferKernel) (_γ : ℝ) : Prop := True
...
def MassGap (_μ : LatticeMeasure) (_γ : ℝ) : Prop := True

/-- Continuum mass gap (interface wrapper). -/
def MassGapCont (_γ : ℝ) : Prop := True
